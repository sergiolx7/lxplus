const LX_BUILD = 'R12.4-UI11-BOOKS-V8-20260926';
...
const CORE = ['./', './index.html', './lxplus.bundle.js', './lxplus.album-grouping.js', './lxplus.bundle.css',
  ...
  './lxplus.player-context-v6.js', './lxplus.player-context-v6.css', './lxplus.music-polish-v7.css', './lxplus.books-v8.js', './lxplus.books-v8.css',
...
const BOOKS_SCRIPT = '<script src="./lxplus.books-v8.js?v=20260926-1"></script>';
...
async function decorateHtml(response) {
  ...
  if (!text.includes('lxplus.books-v8.js')) scripts.push(BOOKS_SCRIPT);
