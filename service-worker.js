const CACHE='lxplus-shell-2620';
const CORE=['./','./index.html','./app.css','./lxplus.js','./manifest.webmanifest','./lxplus-brand-v262.png','./lxplus-brand-v26.svg','./assets/icon.svg','./assets/icon-maskable.svg','./app-icon-192.png','./app-icon-512.png','./app-icon-maskable-512.png'];
