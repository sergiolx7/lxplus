...
(()=>{
 ...
 window.__LX_MODULES=window.__LX_MODULES||{};window.__LX_MODULES['music-smart-metadata']='31.8';
})();


/* ===== LX Plus v31.8 · Smart Artwork + Cast + Sports Live ===== */
(()=>{
 'use strict';
 ...
 window.__LX_MODULES=window.__LX_MODULES||{};window.__LX_MODULES['v31.8-smart-media']='31.8';
})();
