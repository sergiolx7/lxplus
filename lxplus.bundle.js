...
/* ===== lxplus.js ===== */
window.__LX_JS_BUILD='NOVA-20260924-R10-AUDIO-AUTO';

/* ===== config.js · LX Plus v25.50 ===== */
window.LX=window.LX||{};
LX.config={
  version:'NOVA-20260924-R10-AUDIO-AUTO',
...
window.__LX_MODULES=window.__LX_MODULES||{};window.__LX_MODULES['drive-storage']='R9';
...
(()=>{
 ...
 const driveStreamCandidates=id=>{id=clean(id);if(!id)return[];const q=encodeURIComponent(id),lx=LX.driveStorage?.streamUrl?.(id)||'';if(lx&&LX.driveStorage?.configured?.())return [lx];return [lx,`https://drive.usercontent.google.com/download?id=${q}&export=download&confirm=t`,`https://drive.google.com/uc?export=download&id=${q}&confirm=t`].filter(Boolean)};
