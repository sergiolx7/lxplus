...
const jsFiles = ['lxplus-artwork.js', 'lxplus.js', 'lxplus-v27.js', 'service-worker.js'];
...
check('manifest and v28.3 cache agree', () => {
  ...
  assert.match(sw, /lxplus-shell-v2803/);
  for (const file of ['app-v27.css', 'app-v28.css', 'lxplus-artwork.js', 'lxplus-v27.js', 'assets/lx-music-fallback.svg', 'assets/lxplus-logo-v27.png', 'assets/icon-v27.svg']) assert.ok(sw.includes(file));
});
