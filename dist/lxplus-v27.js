...
(()=>{
  ...
  const logo='assets/lxplus-logo-v27.png?v=28.3';
  const wait=ms=>new Promise(resolve=>setTimeout(resolve,ms));
  const standalone=()=>window.matchMedia?.('(display-mode: standalone)').matches||navigator.standalone===true;

  LX.v27={version:'28.3',spotifyCache:{tracks:[],artists:[],albums:[],playlists:[]}};
  ...
  window.__LX_MODULES=window.__LX_MODULES||{};window.__LX_MODULES.v27='28.3';
})();
